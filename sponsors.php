...
<body>
    ...
    <div class="container vhmavi-container">
        <div class="row row-cols-9 row-cols-md-4 row-cols-lg-3 justify-content-center">
            <div class="col-12 col-lg-9">
                <h1><?php echo $lang['sponsors-paragraph1Header']; ?></h1>
            </div>
            <div class="col vhmavi-sponsor-col">
            ...
            <div class="col vhmavi-sponsor-col" id="vhmavi-col-gse-foundation">
